...
# graphviz + diagrams の vscode
[aws構成図を作成するため graphviz + diagrams の vscode の環境を chocolateyで30分ぐらいで作る 2020-10-03](https://qiita.com/lunar_sword3/items/9f043d8a1c5a3e608cc4)
...
## 5.2 エクステンションを追加する  
[下記の Python extension for Visual Studio Code を追加します。](https://marketplace.visualstudio.com/items?itemName=ms-python.python)
...
# diagrams の nodes  
[diagrams の nodes の一覧 2020-10-03](https://qiita.com/lunar_sword3/items/6a488b4b65ea65be8fb8)  
