'''
webeasyplay /logging_sync_qt 
https://github.com/webeasyplay/logging_sync_qt
'''
...
try:
    ...
    from qtpy.uic import loadUi as QUiLoader
...
class MyWidget(QWidget):
    ...
    def __init__(self, ui_file, parent=None):
        ...
        #loader = QUiLoader()
        self.window = QUiLoader(ui_file)#loader.load(ui_file)
