...
for i,trim_ref_info in enumerate(data["trim_ref_info"]):
    ...
    print('data["trim_ref_info"][\'ref_fpath_16K\']: %s'%(data["trim_ref_info"]['ref_fpath_16K']))
    print('data["trim_ref_info"][\'ref_fpath_48K\']: %s'%(data["trim_ref_info"]['ref_fpath_48K']))    
