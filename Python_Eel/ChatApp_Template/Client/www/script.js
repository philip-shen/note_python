...
function login()
{
	...
	userInput = document.getElementById("loginHost")	
	host = userInput.value
	userInput = document.getElementById("loginPort")	
	port = userInput.value

	console.log("Logging in as " + username + " ...")
	console.log("Attempting to connect...")
	
	eel.connect(username, host, port)
