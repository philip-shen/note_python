...
#
    ...
    'list_out_file',    
    'list_out_ML_file',    
    'list_out_all_tickers_MA_cnts_file',   
...
def list_out_all_tickers_MA_cnts_file(path_filename: str, content: list, opt_verbose='OFF'):
    ...
    with open(path_csv_fname, 'w', encoding='utf-8') as f:
        f.write(f"ticker,stock_name,open,close,high,low,prev_day_close,weight,MAs_status/volume,volume_avg_weekly,MA_3days,MA_5days,MA_7days,MA_13days,MA_28days,MA_84days,MA_10days,MA_20days,MA_60days,ShortTerm_BBband_Middle,ShortTerm_BBband_Upper,ShortTerm_BBband_Lower,MediumTerm_BBband_Middle,MediumTerm_BBband_Upper,MediumTerm_BBband_Lower,RSI,MACD,MACD_Signal,MACD_Histogram,Volume_avg_Weekly,Volume_avg_BiWeekly,Volume_avg_Monthly,Volume_avg_Quarterly,ShortMediumTerm_Trend_flag,ShortMediumTerm_MA_flag,End_Date,ShortMediumTerm_Trade_Volume_flag,MAs_status,Date,Latest_Dividend_Cover_Days,Total_Stock_Dividend,close_prev-day_5,close_prev-day_10,close_prev-day_20,close_prev-day_60,close_prev-day_84,MA_50days,MA_100days,VWMA\n")
        for line in content:
