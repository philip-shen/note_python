...
class TWSE_TPEX_MAs_status():
    ...
    def update_MAs_status_on_gspreadsheet(self, list_MA_data):
        ...
        for count, worksheet_spread in enumerate(list_worksheet_spread):    
            ...
            dict_stock_price_OHLC= localGoogleSS.update_GSpreadworksheet_MA_status(inital_row_num, list_MA_data)
            est_timer(t1)
...
if __name__ == '__main__':
    ...
    '''
    path_csv_fname = pathlib.Path(dirnamelog)/'2024-12-31_ML_TWS_319_MA.csv'
    with open(path_csv_fname, 'r') as read_obj: # read csv file as a list of lists
    ...
    #logger.info(f'list_of_rows[0]: {list_of_rows[0]}')
    '''
    local_twse_tpex_ma_status = TWSE_TPEX_MAs_status(json_data, json_gsheet, list_path_pickle_ticker, local_stock, opt_verbose)
    
    #local_twse_tpex_ma_status.update_MAs_status_on_gspreadsheet(list_MA_data=list_of_rows[0])
    local_twse_tpex_ma_status.update_200MA_plan_on_gspreadsheet()
