...
from yahoo_finance_async import Interval, History
...
async def yfinance_asyncio(json_data: dict, opt_verbose='OFF'):    
...
if __name__ == '__main__':
    ...
    # Fetch coroutine
    asyncio.run(yfinance_asyncio(json_data, opt_verbose=opt_verbose))
